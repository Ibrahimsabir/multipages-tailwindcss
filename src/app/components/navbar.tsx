...
<nav className="md:ml-8  flex flex-wrap items-center font-semibold text-base justify-center">
  ...
  <Link href={"../about/aboutnested"} className="mr-5 text-white hover:border-b-2 border-white transition-colors duration-200 cursor-pointer" >Nested About</Link>
  ...
  <Link href={"../contact/contactnested"} className="mr-8 text-white hover:border-b-2 border-white transition-colors duration-200 cursor-pointer" >Nested Contact</Link>
</nav>
